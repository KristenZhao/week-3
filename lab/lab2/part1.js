...
Set variables "query1" through "query8" by using an underscore function to answer
the specified question. When you are finished, check your browser's console log to test the results.
...
/* =====================
If Nathan and Jeff play a board game, what are their options? This should be a
list of all games owned by Jeff or Nathan, with no duplicates.
===================== */
