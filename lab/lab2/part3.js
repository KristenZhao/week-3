...
One way to do this is by using _.filter, but you can try other solutions as well. Set your answer to variable "largeStationList".
...
var largeStationList = _.filter(data,function(item){return item[3] > 20;});

console.log(largeStationList);

var largeStationCount = _.countBy(data,function(item){return item[3] > 20 ? 'large':'small';});
//console.log(data.length);
console.log('Large Stations with more than 20 docks: ', largeStationCount.large);
